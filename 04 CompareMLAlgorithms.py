...
def main(transferLearning = "YES"):
    ...
    for n in [200, 400, 1000, 2000, 3000, 4000, 5000]:  
        ...
        plotTitle = 'Boxplot: Accuracy of Baseline Classifiers with N = %s' % n
        ...
        file = './Output/accuracyList%s.txt' % transferLearning
        accuracyList.to_csv(file, sep=',', index=False)
    
    file = './Output/accuracyListComplete%s.txt' % transferLearning
    accuracyList.to_csv(file, sep=',', index=False)
